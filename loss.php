...
if (isset($_GET['logout'])) {
    session_destroy();
    header('Location: https://academic-internship-project.netlify.app/Login.html');
    exit;
}
...
<div class="netnav">
    ...
    <div style="display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; width: 100%;">
        <div>
            <a href="https://academic-internship-project.netlify.app/index.html">HomePage</a>
            <a href="https://academic-internship-project.netlify.app/Stock.html">Stocks</a>
            <a href="loss.php">Calculator</a>
            <a href="https://academic-internship-project.netlify.app/Contact.html">Contact Us</a>
            <a href="https://academic-internship-project.netlify.app/FAQ.html">FAQ</a>
            <a href="https://academic-internship-project.netlify.app/Login.html">Login</a>
            <a href="https://academic-internship-project.netlify.app/signup.html">Create New Account</a>
        </div>
        ...
        <div style="background:#ffebee; padding:15px; border-radius:5px; margin-bottom:20px; border-left:4px solid #e74c3c;">
            ...
            <?php if (strpos($api_error, 'Authentication') !== false): ?>
                <p style="color:#666; margin-top:5px; font-size:14px;">
                    Please <a href="https://academic-internship-project.netlify.app/Login.html" style="color:#3498db;">login</a> first to save data.
                </p>
            <?php endif; ?>
        </div>
    <?php endif; ?>
